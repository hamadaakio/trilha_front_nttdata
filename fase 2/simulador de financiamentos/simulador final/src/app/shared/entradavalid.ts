...
export const entradaValidator: ValidatorFn = (
  ...
  if (valorImovel && valorEntrada) {
    ...
    return parseValorEntrada < porcentagem ? { valoresIguais: true } : null;
  }

  return valorImovel && valorEntrada ? { valoresIguais: true } : null;
};
